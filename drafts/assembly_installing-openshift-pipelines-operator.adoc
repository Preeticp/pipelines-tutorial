...
// Installing the OpenShift Pipelines Operator[leveloffset=+1]
include:: proc_installing-openshift-pipelines-operator.adoc

// Creating Custom Resources for the OpenShift Pipelines Operator[leveloffset=+1]
include::proc_creating-custom-resources-for-OpenShift-pipelines-operator.adoc
