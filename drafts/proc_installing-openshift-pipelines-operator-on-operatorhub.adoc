...
+
NOTE:  The editor is pre-populahttps://asciidoctor.org/docs/user-manual/ ted with definitions. Configure the file by manually entering YAML or JSON definitions, or by dragging and dropping a file into the editor.
