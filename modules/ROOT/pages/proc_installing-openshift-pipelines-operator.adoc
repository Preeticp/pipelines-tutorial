...
+
image::/modules/ROOT/assets/images/openshift_pipelines_create_name_project.png[]
...
+
image::/modules/ROOT/assets/images/openshift_pipelines_operator_tiles.png[]

. The *OpenShift Pipelines Operator* screen providing a brief description of the operator is displayed. Click *Install*.
+
image::/modules/ROOT/assets/images/openshift_pipelines_install_subscription.png[]
