...
+
image::/modules/ROOT/assets/images/openshift_pipelines_installed.png[]

. Click *Create New* to create an instance of the Openshift Pipelines install CRD.
+
image::/modules/ROOT/assets/images/openshift_pipelines_create_new.png[]
...
+
image::/modules/ROOT/assets/images/openshift_pipelines_operator_crd_editor.png[]
+
...
+
image::/modules/ROOT/assets/images/openshift_pipelines_installed_operator.png[]
...
+
image::/modules/ROOT/assets/images/openshift_pipelines_install_overview.png[]

. Check on OpenShift Pipelines Operator by navigating to *Workloads > Pods*.
+
image::/modules/ROOT/assets/images/openshift_pipelines_workloads_pods.png[]
